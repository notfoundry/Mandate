...
public class TestRunner {
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(ClassSyntaxInheritanceTest.class, ClassSyntaxOverrideTest.class, OptionalCommandArgumentTest.class, CommandFlagTest.class);
