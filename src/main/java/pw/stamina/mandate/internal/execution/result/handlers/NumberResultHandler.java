 ...
 * @author Foundry
 */
public class NumberResultHandler implements ExecutableResultHandler<Number> {
    @Override
    public CommandResult generateResult(Number output) {
        return ResultFactory.immediate(String.valueOf(output), CommandResult.Status.COMPLETED);
    }
